      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="createLobbyForm">
              <div class="mb-3">
                ...
                <input type="text" id="lobbyName" required placeholder="Masukkan nama lobby" class="form-control" />
              </div>
          ...
          <div class="modal-footer">
            ...
            <button type="submit" form="createLobbyForm" class="btn btn-red">Buat Lobby</button>
          </div>
        </div>
      </div>
    </div>
